...
execute unless data storage rsot:jukebox {can_restart:true} as @n[type=minecraft:marker,tag=rsot_jukebox] run function rsot:jukebox/update_now_playing_index {reverse:true}
