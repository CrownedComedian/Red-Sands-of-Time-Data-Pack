...
$function rsot:data/set_depth_for_path_type {path_type:"red_key", depth:$(red_key_depth)}
$function rsot:data/set_depth_for_path_type {path_type:"red_vault", depth:$(red_vault_depth)}

$function rsot:data/set_depth_for_path_type {path_type:"yellow_key", depth:$(yellow_key_depth)}
$function rsot:data/set_depth_for_path_type {path_type:"yellow_vault", depth:$(yellow_vault_depth)}

$function rsot:data/set_depth_for_path_type {path_type:"green_key", depth:$(green_key_depth)}
$function rsot:data/set_depth_for_path_type {path_type:"green_vault", depth:$(green_vault_depth)}

$function rsot:data/set_depth_for_path_type {path_type:"lapis_key", depth:$(lapis_key_depth)}
$function rsot:data/set_depth_for_path_type {path_type:"lapis_vault", depth:$(lapis_vault_depth)}

$function rsot:data/set_depth_for_path_type {path_type:"pink_key", depth:$(pink_key_depth)}
$function rsot:data/set_depth_for_path_type {path_type:"pink_vault", depth:$(pink_vault_depth)}

# $function rsot:data/set_depth_for_path_type {path_type:"cyan_key", depth:$(cyan_key_depth)}
# $function rsot:data/set_depth_for_path_type {path_type:"cyan_vault", depth:$(cyan_vault_depth)}

# $function rsot:data/set_depth_for_path_type {path_type:"gray_key", depth:$(gray_key_depth)}
# $function rsot:data/set_depth_for_path_type {path_type:"gray_vault", depth:$(gray_vault_depth)}

# $function rsot:data/set_depth_for_path_type {path_type:"purple_key", depth:$(purple_key_depth)}
# $function rsot:data/set_depth_for_path_type {path_type:"purple_vault", depth:$(purple_vault_depth)}

# set algorithms

function rsot:data/set_algorithm_for_path_type {path_type:"dead_end", algorithm:"terminal"}

$function rsot:data/set_algorithm_for_path_type {path_type:"red_key", algorithm:$(red_key_algorithm)}
$function rsot:data/set_algorithm_for_path_type {path_type:"red_vault", algorithm:$(red_vault_algorithm)}

$function rsot:data/set_algorithm_for_path_type {path_type:"yellow_key", algorithm:$(yellow_key_algorithm)}
$function rsot:data/set_algorithm_for_path_type {path_type:"yellow_vault", algorithm:$(yellow_vault_algorithm)}

$function rsot:data/set_algorithm_for_path_type {path_type:"green_key", algorithm:$(green_key_algorithm)}
$function rsot:data/set_algorithm_for_path_type {path_type:"green_vault", algorithm:$(green_vault_algorithm)}

$function rsot:data/set_algorithm_for_path_type {path_type:"lapis_key", algorithm:$(lapis_key_algorithm)}
$function rsot:data/set_algorithm_for_path_type {path_type:"lapis_vault", algorithm:$(lapis_vault_algorithm)}

$function rsot:data/set_algorithm_for_path_type {path_type:"pink_key", algorithm:$(pink_key_algorithm)}
$function rsot:data/set_algorithm_for_path_type {path_type:"pink_vault", algorithm:$(pink_vault_algorithm)}

# $function rsot:data/set_algorithm_for_path_type {path_type:"cyan_key", algorithm:$(cyan_key_algorithm)}
# $function rsot:data/set_algorithm_for_path_type {path_type:"cyan_vault", algorithm:$(cyan_vault_algorithm)}

# $function rsot:data/set_algorithm_for_path_type {path_type:"gray_key", algorithm:$(gray_key_algorithm)}
# $function rsot:data/set_algorithm_for_path_type {path_type:"gray_vault", algorithm:$(gray_vault_algorithm)}

# $function rsot:data/set_algorithm_for_path_type {path_type:"purple_key", algorithm:$(purple_key_algorithm)}
# $function rsot:data/set_algorithm_for_path_type {path_type:"purple_vault", algorithm:$(purple_vault_algorithm)}