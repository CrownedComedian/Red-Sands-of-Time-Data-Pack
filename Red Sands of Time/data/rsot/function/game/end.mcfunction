...
# Undo pregame effects if the game was ended during pregame by an admin
execute if data storage rsot:game {state:"pregame"} run function rsot:game/end_from_pregame
