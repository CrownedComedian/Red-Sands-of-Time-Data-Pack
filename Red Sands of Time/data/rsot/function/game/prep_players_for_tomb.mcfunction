...
execute if block ~ ~ ~ minecraft:command_block[facing=north] run tp @a[distance=0..100] ^ ^5 ^30 0 0
execute if block ~ ~ ~ minecraft:command_block[facing=south] run tp @a[distance=0..100] ^ ^5 ^30 180 0
execute if block ~ ~ ~ minecraft:command_block[facing=east] run tp @a[distance=0..100] ^ ^5 ^30 90 0
execute if block ~ ~ ~ minecraft:command_block[facing=west] run tp @a[distance=0..100] ^ ^5 ^30 270 0