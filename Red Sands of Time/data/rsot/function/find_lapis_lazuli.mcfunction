...
execute if score @s lapis_pickup_cooldown matches ..0 run scoreboard players reset @s recent_lapis_pickup
...
title @s subtitle [{"text":"$","color":"#5a82e2"},{"score":{"name":"@p","objective":"recent_lapis_pickup"}}]
title @s title ""
