...
data modify storage rsot:teams red_rabbits.display_name set value '{"text":"Red Rabbits","color":"red"}'
...
data modify storage rsot:teams orange_ocelots.display_name set value '{"text":"Orange Ocelots","color":"gold"}'
...
data modify storage rsot:teams yellow_yaks.display_name set value '{"text":"Yellow Yaks","color":"yellow"}'
...
data modify storage rsot:teams lime_llamas.display_name set value '{"text":"Lime Llamas","color":"green"}'
...
data modify storage rsot:teams green_geckos.display_name set value '{"text":"Green Geckos","color":"dark_green"}'
...
data modify storage rsot:teams cyan_coyotes.display_name set value '{"text":"Cyan Coyotes","color":"dark_aqua"}'
...
data modify storage rsot:teams aqua_axolotls.display_name set value '{"text":"Aqua Axolotls","color":"aqua"}'
...
data modify storage rsot:teams blue_bats.display_name set value '{"text":"Blue Bats","color":"blue"}'
...
data modify storage rsot:teams purple_pandas.display_name set value '{"text":"Purple Pandas","color":"dark_purple"}'
...
data modify storage rsot:teams pink_parrots.display_name set value '{"text":"Pink Parrots","color":"light_purple"}'
